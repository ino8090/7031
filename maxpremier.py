...
def start_m3u_stream():
    ...
    while True:
        ...
        drawtext_title = (
            f"drawtext=text='{escaped_title}':fontfile='/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf':fontcolor=white:fontsize=25:"
        ...
        if film_duration is not None:
            ...
            drawtext_remaining = (
                f"drawtext=text='\\: {remaining_time_text}':fontfile='/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf':fontcolor=white:fontsize=25:"
                f"borderw=2:bordercolor=black:x=30:y=h-th-30"
            )
        else:
            drawtext_remaining = (
                f"drawtext=text='\\':fontfile='/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf':fontcolor=white:fontsize=25:"
                f"borderw=2:bordercolor=black:x=30:y=h-th-30"
            )
